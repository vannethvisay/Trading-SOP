              ...
              <div className="flex-1">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="mt-1 text-sm font-medium text-gray-800">{alert.message}</p>
                  </div>
                  <span className="text-xs text-gray-500">{alert.time}</span>
                </div>
                <div className="flex space-x-2 mt-3">
                  <button className="text-xs text-blue-600 bg-blue-50 px-3 py-1 rounded-full">View</button>
                  <button className="text-xs text-gray-600 bg-gray-100 px-3 py-1 rounded-full">Dismiss</button>
                </div>
              </div>
            </div>
          </div>
